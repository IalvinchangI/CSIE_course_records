...
PATH = r".\model"
MODEL_PATH = os.path.join(PATH, "P1")
# MODEL_PATH = os.path.join(PATH, "train2P1")

MODEL_FILE_NAME = "QT_model1_1_9_97" + ".pickle"
# MODEL_FILE_NAME = "QT_model1_1_9_56" + ".pickle"
...
class MLPlay:
    ...
    def update(self, scene_info: dict, *args, **kwargs):
        ...
        # print(state, action, self.model.Qtable(*state))
