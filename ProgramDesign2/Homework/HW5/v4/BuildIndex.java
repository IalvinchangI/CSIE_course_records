...
public class BuildIndex {
    private static void serialize(String corpusFileName, Object obj) throws IOException {
        FileOutputStream fos = null;
        ObjectOutputStream oos = null;
        try {
            fos = new FileOutputStream(corpusFileName + ".ser");
    ...
    public static void main(String[] args) throws IOException {
        ...
        IndexerContainer indexerContainer = new IndexerContainer(corpusFileName);
        ...
        serialize(corpusFileName, indexerContainer.getWords());
        for (String word : indexerContainer.getWords()) {
            Indexer indexer = new Indexer();
            indexer.numbers = indexerContainer.getNumbers(word);
            indexer.values = indexerContainer.getValues(word);
            serialize(corpusFileName + "_" + word, indexer);
        }
