...
void Mesh::setModel(glm::mat4 &model) { model_ = model; }
...
void Mesh::draw(glm::mat4 &view, glm::mat4 &projection)
{
    ...
    shaderProgram_->setValue<4, 4>("modelMatrix", model_, false);
    shaderProgram_->setValue<3, 3>("normalMatrix", glm::mat3(glm::transpose(glm::inverse(model_))), false);
